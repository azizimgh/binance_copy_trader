...
import discum
bot = discum.Client(token='NzUxODYyMTUxNzIzMDg5OTMx.Gz07_C.w0JS9lGeNUEM8bFMoxh0fprpootv-v_5wsPfKI')
...
# 817849157321490454/821112192379256894
members = get_members('817849157321490454', '824249156876238901') #yes, the channel_id input is required
